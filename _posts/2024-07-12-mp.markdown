...
layout:     post
title:   "Linux基础——Linux系统之ls命令的基本使用"
author: "江湖有缘"
header-style: text
catalog: true
tags:
...
@[TOC](Linux系统之ls命令的基本使用)


![在这里插入图片描述](https://img-blog.csdnimg.cn/6f827cf118c04779b853290092e065d4.jpeg#pic_center)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/895bc01d1ed1451c92bb54ba726025f0.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/c771c89b431745a19f3d9b61a77542c1.png)
